...
# LOSS
cfg.LOSS = CN()
cfg.LOSS.KEYPOINT_3D_LOSS_WEIGHT = 300.
cfg.LOSS.KEYPOINT_2D_LOSS_WEIGHT = 300.
cfg.LOSS.CAM_LOSS_WEIGHT = 60.
cfg.LOSS.DEPTH_LOSS_WEIGHT = 9.
